...
A responsive, server-rendered PHP portfolio, extending the existing static project without adding a frontend framework. It includes 7 main pages, 12 service pages, 2 confirmed case studies, 6 starter articles, a private content manager and a SQLite-backed enquiry pipeline.
